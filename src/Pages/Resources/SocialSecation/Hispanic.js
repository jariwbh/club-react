                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 animate-top text-center">
                            <h2 className="mrb30">Ras Al Hamra Hispanic Section News Update</h2>
                        </div>
                    </div>
                    {/* <img className="img-fluid mb-3" src={image.kayakimg1} /> */}
                    <p className="text-justify">
                        Hello! Bonjour!<br/>
                        In case you haven't heard of us yet, the Hispanic Section is a registered section of the RAHRC. Its mandate is to promote Hispanic culture, and organize activities and events with a Hispanic flavor for RAHRC members and their guests. 
                    </p>
                    <h6>The Hispanic Section committee is made up of:</h6>
                    <ul>
                    ...
                    <p className="text-justify">
                        The Hispanic Section has an email account which will be used to communicate details of our activities to Hispanics living in Oman. To be added to the distribution list, please send us your contact information to <a href="mailto:canadiansinoman@gmail.com">canadiansinoman@gmail.com</a>. Also, if you are interested in joining the Hispanic Section committee, please let us know, we would love to meet you! 
                    </p>
                    <p className="text-justify">
                        We generally plan for two Hispanic events per year, the first is our Annual Hispanic Stampede Party at RAHRC â€“ March 3, 2017 will be the 24th Annual Event.
                    </p>
                    <p className="text-justify">
                        This is a great party and usually sells out in record time, attesting to its popularity. 
                    </p>
                    <p className="text-justify">
                        The second event is our Annual Hispanic Thanksgiving dinner at RAHRC which is held on or close to the date of the Hispanic Thanksgiving in October. Watch for details and don't miss the chance to share a turkey dinner with other Hispanics.
                    </p>
                    <p className="text-justify">

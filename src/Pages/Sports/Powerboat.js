                    ...
                    <div className="container">
                        <div className="row" >
                            <div className="col-md-8">
                                ...
                                <p className="text-justify">RAHRC owns a number of powerboats that are used for various activities, these include diving,sailing support, fishing and safety afloat.
                            ...
                            <div className="col-md-4">
                                <div className="text-justify mt4 "> <img className="img-fluid mt-5" src={image.powerboatimg1} alt="" /> </div>
                            </div>
                        </div>
                    </div>
                </section>
                <section className="mrt0  pt-5">
                    <div className="container">
                        <div className="row" >
                            <div className="col-md-4">
                                <div className="text-justify mt4 "> <img className="img-fluid" src={image.powerboatimg2} alt="" /> </div>
                            </div>
                            <div className="col-md-8">
                                <h3 >RYA Level 1 (Start Powerboating) Course</h3>
                                <p className="justify-content-lg-end">
                ...
                <section className="mrt0 pt-5">
                    <div className="container">
                        <div className="row" >
                            ...
                            <div className="col-md-4">
                                <div className="text-justify mt4 "> <img className="img-fluid mt-5" src={image.powerboatimg3} alt="" /> </div>
                            </div>
                        </div>
                    </div>
                </section>

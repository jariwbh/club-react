...
function VenueCards() {
    ...
    return (
        <div className="container">
            <div className="white-box p-3 mb-3">
                <div className="row">
                    <div className="col-xl-2 col-lg-3 col-md-3 mb-3 mb-md-0">
                        <img src={pic4} className="img-fluid" height='100%' />
                    </div>
                    <div className="col-xl-4 col-lg-5 col-md-6 mb-3 mb-md-0">
                        <h3 className="h4 mb-3">Falcon Room</h3>
                        <p className="mb-0">Capacity: 30<br />
                    ...
                    <div className="col-xl-4 offset-xl-2 col-lg-3 offset-lg-1 col-md-3">
                        <h3 className="h4 mb-3">Venue Charges</h3>
                        <p className="mb-0">RO 50 </p>
                    </div>
                </div>
            </div>
            <div className="white-box p-3 mb-3">
                <div className="row">
                    ...
                    <div className="col-xl-4 col-lg-5 col-md-6 mb-3 mb-md-0">
                        <h3 className="h4 mb-3">Palm Room</h3>
                        <p className="mb-0">Capacity: 30<br />
            ...
            <div className="white-box p-3 mb-3">
                <div className="row">
                    ...
                    <div className="col-xl-4 col-lg-5 col-md-6 mb-3 mb-md-0">
                        <h3 className="h4 mb-3">Cinema Hall</h3>
                        <p className="mb-0">Capacity: 150<br />
                            Purposes:  Chamber Orchestra, Fitness, RAHADS Quiz Night<br />
                            & Theatrical  Production.</p>
                    </div>
                    <div className="col-xl-4 offset-xl-2 col-lg-3 offset-lg-1 col-md-3">
                        <h3 className="h4 mb-3">Venue Charges</h3>
                        <p className="mb-0">RO 300 </p>
                    </div>
                </div>
            </div>
            <div className="white-box p-3 mb-3">
                <div className="row">
                    <div className="col-xl-2 col-lg-3 col-md-3 mb-3 mb-md-0">
                        <img src={pic11} className="img-fluid" />
                    </div>
                    <div className="col-xl-4 col-lg-5 col-md-6 mb-3 mb-md-0">
                        <h3 className="h4 mb-3">Boat Club Roof Top</h3>
                        <p className="mb-0">Capacity: 20<br />
            ...
            <div className="white-box p-3 mb-3">
                <div className="row">
                    ...
                    <div className="col-xl-4 col-lg-5 col-md-6 mb-3 mb-md-0">
                        <h3 className="h4 mb-3">Sohar Garden</h3>
                        <p className="mb-0">Capacity: 300<br />
            ...
            <div className="white-box p-3 mb-3">
                <div className="row">
                    ...
                    <div className="col-xl-4 col-lg-5 col-md-6 mb-3 mb-md-0">
                        <h3 className="h4 mb-3">Marlin Hall</h3>
                        <p className="mb-0">Capacity: 100<br />
                            Purposes:  Meeting, Conference, Section Event, Party<br />
                            & Club Event.</p>
                    </div>
                    <div className="col-xl-4 offset-xl-2 col-lg-3 offset-lg-1 col-md-3">
                        <h3 className="h4 mb-3">Venue Charges</h3>
                        <p className="mb-0">RO 200 </p>
                    </div>
                </div>
            </div>
            <div className="white-box p-3 mb-3">
                <div className="row">
                    <div className="col-xl-2 col-lg-3 col-md-3 mb-3 mb-md-0">
                        <img src={pic8} className="img-fluid" />
                    </div>
                    <div className="col-xl-4 col-lg-5 col-md-6 mb-3 mb-md-0">
                        <h3 className="h4 mb-3">Sports Bar</h3>
                        <p className="mb-0">Capacity: 20<br />
            ...
            <div className="white-box p-3 mb-3">
                <div className="row">
                    <div className="col-xl-2 col-lg-3 col-md-3 mb-3 mb-md-0">
                        <img src={pic10} className="img-fluid" />
                    </div>
                    <div className="col-xl-4 col-lg-5 col-md-6 mb-3 mb-md-0">
                        <h3 className="h4 mb-3">Golf Course Range</h3>
                        <p className="mb-0">Capacity:  500 - 1000<br />
                            Purposes:   Golf Range for gatherings and weddings.<br />
                        </p>
                    </div>
                    <div className="col-xl-4 offset-xl-2 col-lg-3 offset-lg-1 col-md-3">
                        <h3 className="h4 mb-3">Venue Charges</h3>
                        <p className="mb-0">RO 1500 </p>
                    </div>
                </div>
            </div>
            <div className="white-box p-3 mb-3">
                <div className="row">
                    ...
                    <div className="col-xl-4 col-lg-5 col-md-6 mb-3 mb-md-0">
                        <h3 className="h4 mb-3">Club House Balcony</h3>
                        <p className="mb-0">Capacity: Sitting at table: 40 person; Standing 60 - 70 persons<br />
                    ...
                    <div className="col-xl-4 offset-xl-2 col-lg-3 offset-lg-1 col-md-3">
                        <h3 className="h4 mb-3">Venue Charges</h3>
                        <p className="mb-0">Contact Front office</p>
